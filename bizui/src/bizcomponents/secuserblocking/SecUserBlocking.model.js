...
export default {
  ...
  effects: {
    ...
    *addSecUser({ payload }, { call, put }) {
      ...
      const location = { pathname: `/secUserBlocking/${id}/list/SecUserList/????+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateSecUser({ payload }, { call, put }) {
      ...
      const location = { pathname: `/secUserBlocking/${id}/list/SecUserList/??????`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
