...
export default {
  ...
  effects: {
    ...
    *addUserWhiteList({ payload }, { call, put }) {
      ...
      const location = { pathname: `/userDomain/${id}/list/UserWhiteListList/?????+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateUserWhiteList({ payload }, { call, put }) {
      ...
      const location = { pathname: `/userDomain/${id}/list/UserWhiteListList/???????`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *addSecUser({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/userDomain/${id}/list/SecUserList/????+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateSecUser({ payload }, { call, put }) {
      ...
      const location = { pathname: `/userDomain/${id}/list/SecUserList/??????`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
