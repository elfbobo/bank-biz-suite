...
export default {
  ...
  effects: {
    ...
    *addTransaction({ payload }, { call, put }) {
      ...
      const location = { pathname: `/changeRequest/${id}/list/TransactionList/??+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateTransaction({ payload }, { call, put }) {
      ...
      const location = { pathname: `/changeRequest/${id}/list/TransactionList/????`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *addNameChangeEvent({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/changeRequest/${id}/list/NameChangeEventList/??????+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateNameChangeEvent({ payload }, { call, put }) {
      ...
      const location = { pathname: `/changeRequest/${id}/list/NameChangeEventList/????????`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *addAccountChange({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/changeRequest/${id}/list/AccountChangeList/????+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateAccountChange({ payload }, { call, put }) {
      ...
      const location = { pathname: `/changeRequest/${id}/list/AccountChangeList/??????`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
