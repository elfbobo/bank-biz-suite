...
export default {
  ...
  effects: {
    ...
    *addUserApp({ payload }, { call, put }) {
      ...
      const location = { pathname: `/secUser/${id}/list/UserAppList/??????+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateUserApp({ payload }, { call, put }) {
      ...
      const location = { pathname: `/secUser/${id}/list/UserAppList/????????`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
    ...
    *addLoginHistory({ payload }, { call, put }) {
      ...
      const partialList = true
      const newState = {...data, partialList}
      const location = { pathname: `/secUser/${id}/list/LoginHistoryList/????+${appLocaleName(userContext,'List')}`, state: newState }
      yield put(routerRedux.push(location))
    },
    *updateLoginHistory({ payload }, { call, put }) {
      ...
      const location = { pathname: `/secUser/${id}/list/LoginHistoryList/??????`, state: newPlayload }
      yield put(routerRedux.push(location))
    },
