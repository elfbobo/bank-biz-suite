<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.quicklink.QuickLink'%>
...
<sky:include page="com/doublechain/bank/quicklink/QuickLink$Summary.jsp" />
