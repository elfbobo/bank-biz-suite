<%@ page import='java.util.*,com.doublechain.bank.*,com.doublechain.bank.changerequesttype.ChangeRequestType'%>
...
<sky:include page="com/doublechain/bank/changerequesttype/ChangeRequestType$Summary.jsp" />
