...
public class CandidateContainerManagerImpl extends CustomBankCheckerManager implements CandidateContainerManager {
	...
	protected void throwExceptionWithMessage(String value) throws CandidateContainerManagerException{
 	...
 	protected CandidateContainer saveCandidateContainer(BankUserContext userContext, CandidateContainer candidateContainer, String [] tokensExpr) throws Exception{	
 	...
 	protected CandidateContainer saveCandidateContainerDetail(BankUserContext userContext, CandidateContainer candidateContainer) throws Exception{	
 	...
 	public CandidateContainer loadCandidateContainer(BankUserContext userContext, String candidateContainerId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CandidateContainer searchCandidateContainer(BankUserContext userContext, String candidateContainerId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CandidateContainer present(BankUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateContainer loadCandidateContainerDetail(BankUserContext userContext, String candidateContainerId) throws Exception{	
 	...
 	public Object view(BankUserContext userContext, String candidateContainerId) throws Exception{	
 		CandidateContainer candidateContainer = loadCandidateContainer( userContext, candidateContainerId, viewTokens());
 		return present(userContext,candidateContainer, allTokens());
		
 	}
 	protected CandidateContainer saveCandidateContainer(BankUserContext userContext, CandidateContainer candidateContainer, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getCandidateContainerDAO().save(candidateContainer, tokens);
 	}
 	protected CandidateContainer loadCandidateContainer(BankUserContext userContext, String candidateContainerId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfCandidateContainer(candidateContainerId);
		userContext.getChecker().throwExceptionIfHasErrors( CandidateContainerManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(BankUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(BankUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCandidateContainer(BankUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateContainer clone(BankUserContext userContext, String fromCandidateContainerId) throws Exception{
	...
	public CandidateContainer internalSaveCandidateContainer(BankUserContext userContext, CandidateContainer candidateContainer, Map<String,Object> options) throws Exception 
	{
	...
	public CandidateContainer updateCandidateContainerProperty(BankUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingCandidateContainer(userContext, candidateContainerId, candidateContainerVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(BankUserContext userContext, String candidateContainerId, int candidateContainerVersion) throws Exception {
	...
	public CandidateContainer forgetByAll(BankUserContext userContext, String candidateContainerId, int candidateContainerVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateContainerId, candidateContainerVersion);		
	}
	protected CandidateContainer forgetByAllInternal(BankUserContext userContext,
			String candidateContainerId, int candidateContainerVersion) throws Exception{
	...
	protected void checkParamsForAddingCandidateElement(BankUserContext userContext, String candidateContainerId, String name, String type, String image,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElementProperties(BankUserContext userContext, String candidateContainerId,String id,String name,String type,String image,String [] tokensExpr) throws Exception {
	...
	public  CandidateContainer updateCandidateElementProperties(BankUserContext userContext, String candidateContainerId, String id,String name,String type,String image, String [] tokensExpr) throws Exception
	{	
	...
	protected CandidateElement createCandidateElement(BankUserContext userContext, String name, String type, String image) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElementList(BankUserContext userContext, String candidateContainerId, 
	...
	public  CandidateContainer removeCandidateElementList(BankUserContext userContext, String candidateContainerId, 
			String candidateElementIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElement(BankUserContext userContext, String candidateContainerId, 
	...
	public  CandidateContainer removeCandidateElement(BankUserContext userContext, String candidateContainerId, 
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCandidateElement(BankUserContext userContext, String candidateContainerId, 
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer copyCandidateElementFrom(BankUserContext userContext, String candidateContainerId, 
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElement(BankUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer updateCandidateElement(BankUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
