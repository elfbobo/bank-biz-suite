...
public class ChangeRequestType extends BaseEntity implements  java.io.Serializable{
	...
	public static final String DEPOSITE = "DEPOSITE";	// 存款
	public static final String TRANSFTER = "TRANSFTER";	// 转账
	public static final String WITHDRAW = "WITHDRAW";	// 取款
	public static final String CREATE_ACCOUNT = "CREATE_ACCOUNT";	// 开户
	public static final String CHANGE_NAME = "CHANGE_NAME";	// 改名
	public static List<KeyValuePair> CODE_NAME_LIST;
	static {
		CODE_NAME_LIST = new ArrayList<>();

		CODE_NAME_LIST.add(new KeyValuePair(DEPOSITE, "存款"));
		CODE_NAME_LIST.add(new KeyValuePair(TRANSFTER, "转账"));
		CODE_NAME_LIST.add(new KeyValuePair(WITHDRAW, "取款"));
		CODE_NAME_LIST.add(new KeyValuePair(CREATE_ACCOUNT, "开户"));
		CODE_NAME_LIST.add(new KeyValuePair(CHANGE_NAME, "改名"));
	}
	...
	public 	ChangeRequestType(String name, String code, Platform platform)
	{
		setName(name);
		setCode(code);
